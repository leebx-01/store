    ...
    <div  class="cart py-container">
        ...
        <div class="checkout py-container">
            ...
            <div class="checkout-steps">
                ...
                <div class="hr"></div>
                <!--支付和送货-->
                <form name="frm" action="${pageContext.request.contextPath}/order-web/submitOrder">
                <div class="payshipInfo">
                    ...
                    <div class="step-cont">
                        <ul class="payType">
                            <li class=""><input type="radio" name="paymentType" value="1" checked>微信付款</li>
                            <li class="selected"><input type="radio" name="paymentType" value="2">货到付款</li>
                        </ul>
                    </div>
                    <div class="hr"></div>
                    <div class="step-tit">
                    ...
                    <c:forEach items="${list}" var="l">
                        <input type="hidden" value="${l.id}" name="skuId">
                                ...
                                <div class="sendGoods">
                                    <ul class="yui3-g">
                                            ...
                                            <li class="yui3-u-7-12">
                                                <div class="desc">${l.title}</div>
                                                <div class="seven">7天无理由退货</div>
                                            </li>
                                            <li class="yui3-u-1-12">
                                                <div class="price" name="price">￥${l.price}</div>
                                            </li>
                                            <li class="yui3-u-1-12">
                                                <div class="num">X${l.num}</div>
                                            </li>
                                            <li class="yui3-u-1-12">
        ...
        <div class="clearfix trade">
            <div class="fc-price">应付金额:　<span class="price">¥${sum}</span></div>
