					...
					<div class="all-sort-list2">
						...
						<div class="item bo">
							...
							<div class="item-list clearfix">
								<div class="subitem">
									<c:forEach items="${l.subList}" var="l2" varStatus="vs">
									<dl class="fore${vs.index}">
										<dt><a href="">${l2.name}</a></dt>
										<dd>
										<c:forEach var="l3" items="${l2.subList}">
											<em><a href="${pageContext.request.contextPath}/web/getId?id=${l3.id}&page=1&size=10">${l3.name}</a></em>
										</c:forEach>
										</dd>
									</dl>
									</c:forEach>
